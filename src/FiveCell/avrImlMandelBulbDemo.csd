...
;k2 = p16 * kSineControlVal
;k3 = p14 * kSineControlVal
;gaOut3      granule p4*k1,p5,p6,p7,p8,p9,p10,p11,p12,p13,k3,p15,k2,p17,p18,p19,p20,p21,p22,p23,p24
;gaOut4      granule p4*k1,p5,p6,p7,p8,p9,p10,p11,p12,p13,k3,p15,k2,p17,p18,p19, p20+0.17,p21,p22,p23,p24
;
;
;;outs gaOut3,gaOut4
;
...
;**************************************************************************************
instr 5 ;grain generating instrument 1
;**************************************************************************************
  kRate         =         p4 
...
;**************************************************************************************
instr 6 ;grain generating instrument 2
;**************************************************************************************
  kRate          =        p4 
  kTrig          metro      kRate      ; a trigger to generate grains
  kDur           =         0.02 
...
;f2      0 	262144 	1 	"24cellRow_48k.wav" 	0 	0 	0
